...
The repository has verified P0, P1 and partial P2 implementation on an unmerged branch. Production still serves the older architecture. P2 operational evidence, all P3 authority work, material P4 release controls, the seven-day observation window and the completion certificate remain open.
...
| P2 trust and conversion | Consent, attribution, dedupe, lead owner/score, acknowledgement, trust/job gates, durable CRM retry/escalation and opportunity feedback implemented | New trust/jobs/candidate controls are not live; real integration evidence is absent | `132cfd65c8`, `1572000723`, migration `003_p2_lead_delivery_recovery.sql`; 56 tests pass | PARTIAL |
| P3 authority and regional depth | Unsupported blog/SEO surfaces suppressed; resource page is a governance placeholder | Old broad sitemap/content remains live | Claim and route gates | NOT COMPLETE |
| P4 quality and release governance | Typecheck, tests, full build, route verifier, workflow lint and high-severity audit pass locally | Production header duplication, `unsafe-eval`, old release, no observation window | `d952f68d94`; local quality evidence | PARTIAL |
...
- TypeScript: passed.
- Tests: 15 files, 56 tests passed.
- Full build: passed.
- Prerender: 25 of 25 governed routes passed.
- Release verifier: no duplicate titles/H1s/body fingerprints, canonical mismatches, invalid JSON-LD or broken governed links.
- Workflow syntax: passed with the environment-specific deployment-label warning excluded.
- Dependency gate: no high or critical vulnerability; four moderate development-tool findings remain documented.
- Git: branch clean at `d952f68d947826b9de07ef6e3249f19b5957bc8c` when this matrix was opened; branch pushed to primary Forgejo.
