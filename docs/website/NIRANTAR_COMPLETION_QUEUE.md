...
| NIR-P2-001 | P2 | Lead capture, consent, attribution, deduplication and ownership | WAITING EVIDENCE | `PROVE NIR-P2-EVID-001` is recorded. The approved manifest's three exact buyer records passed real loopback API/PostgreSQL verification. HubSpot is repository-declared as the intended CRM, but its authenticated sandbox portal is not yet visible; founder sign-in, Revenue Operations provider approval and operational SLA proof remain. |
