...
| NIR-P3-001 | P3 | Content governance registry | PENDING | Every public resource has owner, expert reviewer, method/source, approval, review date, expiry and retraction path. |
| NIR-P3-002 | P3 | Buyer-specific journeys and conversion paths | PENDING | Governed journeys for GCC leaders, procurement, hiring managers and candidates with measurable conversion events. |
