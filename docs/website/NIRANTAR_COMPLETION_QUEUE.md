...
| NIR-P2-001 | P2 | Lead capture, consent, attribution, deduplication and ownership | WAITING EVIDENCE | Real API/PostgreSQL loopback verification passed for persistence, consent, attribution, owner/score and deduplication; Revenue Operations-approved provider record and SLA proof remain. |
...
| NIR-P2-005 | P2 | Governed job publication and expiry proof | WAITING EVIDENCE | Real sandbox API/page checks passed for synthetic current `200` and expired/unverified/unknown `404` records; Candidate Operations-approved employer vacancy pack remains. |
