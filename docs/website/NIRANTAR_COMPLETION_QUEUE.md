...
| NIR-P2-001 | P2 | Lead capture, consent, attribution, deduplication and ownership | BLOCKED | `PROVE NIR-P2-EVID-001` is recorded and the exact buyer records passed loopback verification. Authenticated HubSpot portal `244059903` contains active operational data, exposes no sandbox designation and is excluded from testing. An already-created separate non-production portal, Revenue Operations provider approval and operational SLA proof remain. |
