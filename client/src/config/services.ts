...
// The former service catalogue remains above as migration context, but it is
// deliberately not exported and is removed from production bundles by tree
// shaking. Legacy URLs are mapped to a canonical approved offer below.
